def give_bmi(height: list[int | float],
    ...
    # zip creer un iterateur qui combine les listes qui sont directement
    # consommer pour creer une liste de tout les IMC
    return [w / (h ** 2) for h, w in zip(height, weight)]


def apply_limit(bmi: list[int | float], limit: int) -> list[bool]:
    """
    Retourne une liste de bool pour chaque IMC dépasse la limite donnée.
    """
